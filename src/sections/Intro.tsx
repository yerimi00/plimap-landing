  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ width: 48, height: 1, background: 'rgba(253,253,253,0.35)' }} />
        <span>
          새로운 <span style={{ color: '#c8f940' }}>플레이리스트</span>
        </span>
      </h1>

      <img data-reveal src="/uploads/plimap-logo.svg" alt="PLIMAP" style={{ width: '100%', maxWidth: 460, height: 'auto' }} />
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, maxWidth: 360 }}>
          ...
          <p style={{ margin: 0, fontSize: 13, lineHeight: 1.7, color: 'rgba(253,253,253,0.65)' }}>
